...
const AutoTopUpModal = ({ showModal }: Props) => {
	const { data } = useSession();
	const dispatch = useDispatch();
	const { setNotification } = useContext(NotificationContext);
	const { httpIsLoading, sendRequest } = useHttp();

	const httpEnableAutoTopUp = async (e: React.FormEvent) => {
		e.preventDefault();
		...
		dispatch(userSliceActions.updateUserDetails({ autoTopUpEnabled: true }));
		showModal(false);
	};
			...
			<ModalBody>
				<div className={styles.header}>
					<div
						...
						<span className="size_17 bold">Enable Auto Top Up</span>
					</div>
				...
				<form onSubmit={httpEnableAutoTopUp}>
            ...
            <p>
              ...
              funds
					...
					<div className="form-group">
						<label className="mr-sm-2 size_15">SSN</label>
					...
					<div className="form-group">
						<label className="mr-sm-2 size_15">Banking Login</label>
						<div className="input-group mb-3">
							<input
								type="text"
								style={{ backgroundColor: "#000" }}
					...
					<div className="form-group">
						<label className="mr-sm-2 size_15">Password</label>
						<div className="input-group mb-3">
							<input
								type="text"
								style={{ backgroundColor: "#000" }}
