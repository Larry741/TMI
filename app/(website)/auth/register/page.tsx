...
import { TOKEN_KEY, userSliceActions } from "@/store/userSlice";
...
import SignUpMailValidation from "@/components/Page/Auth/RegisterMailValidation";
...
const SignupPage = () => {
	...
	const httpRegisterUser = async (e: React.FormEvent) => {
		e.preventDefault();
	...
	const httpValidateOtp = async (event: React.FormEvent) => {
		...
		let { message, status, error, data } = await sendRequest(
			"POST",
		...
		router.push(`/dashboard?token=${sessionStorage.getItem(TOKEN_KEY)}`);
	};
							...
							<div className="col-12">
								...
								<div className="flat-form box-login-email">
									...
									<div className="form-inner">
										<form onSubmit={httpRegisterUser} id="contactform">
											<input
												id="fname"
												name="firstName"
												tabIndex={1}
										...
										/> */}
											...
											<button className="submit">
												{loading ? <Loader width="23" /> : "Create Account"}
											</button>
										</form>
									</div>
								</div>
